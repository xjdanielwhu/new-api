...
func settleTestQuota(info *relaycommon.RelayInfo, priceData localtypes.PriceData, usage *dto.Usage) (int, *billingexpr.TieredResult) {
...
func buildTestLogOther(c *gin.Context, info *relaycommon.RelayInfo, priceData localtypes.PriceData, usage *dto.Usage, tieredResult *billingexpr.TieredResult) map[string]interface{} {
